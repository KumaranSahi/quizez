        ...
        <div className={classes["my-scores-page"]}>
            <div className={classes["my-scores-container"]}>
                ...
                <Table className={classes.table} aria-label="customized table">
                    <TableHead>
                        <TableRow>
                            <TableCell className={classes["table-head-cell"]}>Quiz</TableCell>
                            <TableCell className={classes["table-head-cell"]} align="right">Score</TableCell>
                            <TableCell className={classes["table-head-cell"]} align="right">Play Again</TableCell>
                        </TableRow>
                    </TableHead>
                <TableBody>
                {myLeaderBoard.map(({id,score,userName,quizName,quizId})=>(
